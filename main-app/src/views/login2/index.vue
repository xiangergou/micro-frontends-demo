/* * @Author: liuxia * @Date: 2019-01-11 16:01:32 * @Last Modified by: liuxia *
...
<template>
  <div class="login-container">
    ...
    >
      ...
      <el-form-item class="login_item" prop="mobile">
        <el-input
          ...
          placeholder="请输入账号"
        >
          <i slot="prefix" class="iconfont icon-user-fill" />
        </el-input>
      </el-form-item>
      <el-form-item class="login_item" prop="password">
        ...
        >
          <i slot="prefix" class="iconfont icon-lock-fill-open" />
        </el-input>
      </el-form-item>
